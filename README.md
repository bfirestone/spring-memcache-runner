...
If you don't have a memcached server running on localhost then some of the tests may fail, you can disable the tests my compiling with the `-Dmaven.test.skip=true` flag
```shell script
